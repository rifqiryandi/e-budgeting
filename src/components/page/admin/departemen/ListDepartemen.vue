        ...
        <div class="p-6 space-y-2">
          <div class="">
            <label
              class="block mb-2 text-base font-medium text-gray-900 dark:text-white"
            >
              Entitas <span class="text-red-600">*</span>
            </label>
            <select
              v-model="Form.entitas"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            >
              <option value="">-- Pilih Entitas --</option>
              <option
            ...
            <p
              ...
              v-if="this.v$.Form.entitas.$error"
            >
              Entitas tidak boleh kosong!
            </p>
          </div>
          <div class="">
            <label
          ...
          <div class="">
            <label
              class="block mb-2 text-base font-medium text-gray-900 dark:text-white"
            >
              Nama Departemen <span class="text-red-600">*</span>
            </label>
            <input
              type="text"
              id="base-input"
              v-model="Form.nama_depart"
              placeholder="Masukkan Nama Departemen"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-bni-blue focus:border-bni-blue block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            />
            <p
              class="mt-2 text-sm text-red-600 dark:text-red-500 m-0"
              v-if="this.v$.Form.nama_depart.$error"
            >
...
export default {
  ...
  methods: {
    ...
    async prosesDelete() {
      ...
      try {
        let respon = await serviceDepartemen.deleteDepartemen(
          payload,
          this.token
        );
        this.modal.hide();
